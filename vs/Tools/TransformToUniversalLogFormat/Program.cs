...
namespace TransformToUniversalLogFormat
{
    class Program
    {
        public class Options
        {
            ...
            public string Mask { get; set; } = "*.jsonl";
            ...
            [Option('r', "rawformat", Required = false, HelpText = "Raw format (either eeibraprawv01a, ibsdraw01a or nepsrawv01a).")]
        ...
        { 
            // Register Code Page for Stata Library
...
#if DEBUG
            args = new string[] { "-i", @"C:\work\day\2019_10_07__VeraDataProcessing\in\",
                "-x", @"C:\work\day\2019_10_07__VeraDataProcessing\out\test.xlsx",
                "-s", @"C:\work\day\2019_10_07__VeraDataProcessing\out\test_dta.zip",
                "-z", @"C:\work\day\2019_10_07__VeraDataProcessing\out\test_csv.zip",
                "-r", @"ibsdraw01a",
                "-a", @"MaxNumberOfCases=12", 
                "-v" };
        ...
        static int RunOptionsAndReturnExitCode(Options options)
        {
            try
            {
                ...
                string _argumentString = options.Arguments;
